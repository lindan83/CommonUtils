...
import com.lance.common.util.spannable.SpannableClickable;

import java.util.regex.Matcher;
import java.util.regex.Pattern;

/**
 * Created by lindan on 16-10-14.
 * 字符串工具
 */
public class StringUtil {
    ...
    /**
     * 格式化字符串，识别并处理其中的URL和手机号码
     *
     * @param contentStr input
     * @param color      color
     * @return SpannableStringBuilder
     */
    public static SpannableStringBuilder formatString(String contentStr, int color) {
            ...
            try {
                ...
                while (urlMatcher.find()) {
                    ...
                    if (!TextUtils.isEmpty(url)) {
                        sp.setSpan(new SpannableClickable(color) {
                            @Override
